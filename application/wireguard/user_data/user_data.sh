...
docker run -d --restart unless-stopped --name wg_server --privileged --cap-add=NET_ADMIN --cap-add=SYS_MODULE -v /dev:/dev -v /etc/pki/tls/certs/:/etc/pki/tls/certs/ -p 443:443 ${__SIGNING_SERVER_IMAGE_URI__}
--//--